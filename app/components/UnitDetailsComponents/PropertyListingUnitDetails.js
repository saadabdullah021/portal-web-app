            ...
            />
              {
                isAuthenticated && (
                  ...
                  <button
                            ...
                            className="p-2 hover:bg-gray-100 flex items-center rounded-full border-2 border-[#E6E8EC] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                          >
                            {isWishlistLoading ? (
                              <div className="w-6 h-6 border-2 border-[#777E91] border-t-transparent rounded-full animate-spin"></div>
                            ) : (
